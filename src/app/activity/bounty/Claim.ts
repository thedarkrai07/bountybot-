...
export const claimBounty = async (request: ClaimRequest): Promise<any> => {
    ...
    const parentBountyChannel = (!!parentBounty || !!parentBounty.canonicalCard) ? await DiscordUtils.getTextChannelfromChannelId(parentBounty.canonicalCard.channelId) : undefined;
